...
/d30be53e8d04880c/                      Final. Auto-logging form → ntfy topic.
```
...
- **Layer 3 → final:** Layer 3 lists 25 short statements (20 about cooking, 5 about astronomy). Solver uses sentence embeddings (OpenAI, Voyage, or local model) to identify the 5 semantic outliers (positions 04, 09, 13, 18, 22). Concatenated as `0409131822`, then `sha256("0409131822" + "finish").slice(0,16)` = `d30be53e8d04880c` for the final path.
